...
expect_section_content nanox 'Operation (0)' 'SR: send messages'
press_button right
expect_section_content nanox 'Fee' '0.01 tz'
press_button right
expect_section_content nanox 'Storage limit' '4'
press_button right
expect_section_content nanox 'Message (0)' '012345'
press_button right
expect_section_content nanox 'Message (1)' '67'
press_button right
expect_section_content nanox 'Message (2)' '89abcdef'
press_button right
