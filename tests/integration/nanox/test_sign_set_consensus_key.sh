...
"
expect_section_content nanox 'Operation (0)' 'Set consensus key'
press_button right
expect_section_content nanox 'Fee' '0.01 tz'
press_button right
expect_section_content nanox 'Storage limit' '4'
press_button right
expect_section_content nanox 'Public key' 'edpkuXX2VdkdXzkN11oLCb8Aurdo1BTAtQiK8ZY9UPj2YMt3AHEpcY'
press_button right
