...
expect_section_content nanox 'Operation (0)' 'Origination'
press_button right
expect_section_content nanox 'Fee' '0.01 tz'
press_button right
expect_section_content nanox 'Storage limit' '4'
press_button right
expect_section_content nanox 'Balance' '0.5 tz'
press_button right
expect_section_content nanox 'Delegate' 'Field unset'
press_button right
expect_section_content nanox 'Code' 'UNPAIR'
press_button right
expect_section_content nanox 'Storage' 'pair "1" 2'
press_button right
