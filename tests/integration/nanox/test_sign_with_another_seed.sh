...
press_button right
expect_section_content nanox 'Fee' '0.05 tz'
press_button right
expect_section_content nanox 'Storage limit' '45'
press_button right
expect_section_content nanox 'Amount' '0.24 tz'
press_button right
expect_section_content nanox 'Destination' 'KT18amZmM5W7qDWVt2pH6uj7sCEd3kbzLrHT'
press_button right
expect_section_content nanox 'Entrypoint' 'do'
press_button right
