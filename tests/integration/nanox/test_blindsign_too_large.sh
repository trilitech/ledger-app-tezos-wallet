...
expect_section_content nanox 'Sign Hash (1/3)' 'H7Gq5omPmhFhDPeyywQ'
press_button right
expect_section_content nanox 'Sign Hash (2/3)' 'QsSb5Mmt2fiBwsgwv'
press_button right
expect_section_content nanox 'Sign Hash (3/3)' 'vuNXzu18Xq'
press_button right
