...
press_button right
expect_section_content nanox 'Amount' '0 tz'
press_button right
expect_section_content nanox 'Destination' 'KT1GW4QHn66m7WWWMWCMNaWmGYpCRbg5ahwU'
press_button right
expect_section_content nanox 'Entrypoint' 'root'
press_button right
expect_section_content nanox 'Parameter' '0'
press_button right
