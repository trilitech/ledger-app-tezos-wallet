...
expect_section_content 'Operation (0)' 'Ballot'
press_button right
expect_section_content 'Source' 'tz1ixvCiPJYyMjsp2nKBVaq54f6AdbV8hCKa'
press_button right
expect_section_content 'Period' '32'
press_button right
expect_section_content 'Proposal' 'ProtoALphaALphaALphaALphaALphaALphaALpha61322gcLUGH'
press_button right
expect_section_content 'Ballot' 'yay'
press_button right
expected_accept
press_button both
