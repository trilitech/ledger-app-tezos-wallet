...
expect_section_content 'Operation (0)' 'Origination'
press_button right
expect_section_content 'Fee' '0.01 tz'
press_button right
expect_section_content 'Storage limit' '4'
press_button right
expect_section_content 'Balance' '0.5 tz'
press_button right
expect_section_content 'Delegate' 'Field unset'
press_button right
expect_section_content 'Code' 'UNPAIR'
press_button right
expect_section_content 'Storage' 'pair "1" 2'
press_button right
