...
press_button right
expect_section_content 'Amount' '0 tz'
press_button right
expect_section_content 'Destination' 'KT1GW4QHn66m7WWWMWCMNaWmGYpCRbg5ahwU'
press_button right
expect_section_content 'Entrypoint' 'root'
press_button right
expect_section_content 'Parameter' '0'
press_button right
