...
expect_section_content 'Operation (0)' 'SR: send messages'
press_button right
expect_section_content 'Fee' '0.01 tz'
press_button right
expect_section_content 'Storage limit' '4'
press_button right
expect_section_content 'Message (0)' '012345'
press_button right
expect_section_content 'Message (1)' '67'
press_button right
expect_section_content 'Message (2)' '89abcdef'
press_button right
