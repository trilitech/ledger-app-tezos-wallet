...
expect_section_content nanos 'Operation (0)' 'Ballot'
press_button right
expect_section_content nanos 'Source' 'tz1ixvCiPJYyMjsp2nKBVaq54f6AdbV8hCKa'
press_button right
expect_section_content nanos 'Period' '32'
press_button right
expect_section_content nanos 'Proposal' 'ProtoALphaALphaALphaALphaALphaALphaALpha61322gcLUGH'
press_button right
expect_section_content nanos 'Ballot' 'yay'
press_button right
