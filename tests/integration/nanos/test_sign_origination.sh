...
expect_section_content nanos 'Operation (0)' 'Origination'
press_button right
expect_section_content nanos 'Fee' '0.01 tz'
press_button right
expect_section_content nanos 'Storage limit' '4'
press_button right
expect_section_content nanos 'Balance' '0.5 tz'
press_button right
expect_section_content nanos 'Delegate' 'Field unset'
press_button right
expect_section_content nanos 'Code' 'UNPAIR'
press_button right
expect_section_content nanos 'Storage' 'pair "1" 2'
press_button right
