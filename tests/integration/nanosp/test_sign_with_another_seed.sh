...
expect_section_content nanosp 'Operation (0)' 'Transaction'
press_button right
expect_section_content nanosp 'Fee' '0.05 tz'
press_button right
expect_section_content nanosp 'Storage limit' '45'
press_button right
expect_section_content nanosp 'Amount' '0.24 tz'
press_button right
expect_section_content nanosp 'Destination' 'KT18amZmM5W7qDWVt2pH6uj7sCEd3kbzLrHT'
press_button right
expect_section_content nanosp 'Entrypoint' 'do'
press_button right
expect_section_content nanosp 'Parameter' 'CAR'
press_button right
