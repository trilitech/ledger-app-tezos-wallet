...
expect_section_content nanosp 'Operation (0)' 'Proposals'
press_button right
expect_section_content nanosp 'Source' 'tz1ixvCiPJYyMjsp2nKBVaq54f6AdbV8hCKa'
press_button right
expect_section_content nanosp 'Period' '32'
press_button right
expect_section_content nanosp 'Proposal (0)' 'ProtoALphaALphaALphaALphaALphaALphaALpha61322gcLUGH'
press_button right
expect_section_content nanosp 'Proposal (1)' 'ProtoALphaALphaALphaALphaALphaALphaALphabc2a7ebx6WB'
press_button right
