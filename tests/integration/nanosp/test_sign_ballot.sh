...
expect_section_content nanosp 'Operation (0)' 'Ballot'
press_button right
expect_section_content nanosp 'Source' 'tz1ixvCiPJYyMjsp2nKBVaq54f6AdbV8hCKa'
press_button right
expect_section_content nanosp 'Period' '32'
press_button right
expect_section_content nanosp 'Proposal' 'ProtoALphaALphaALphaALphaALphaALphaALpha61322gcLUGH'
press_button right
expect_section_content nanosp 'Ballot' 'yay'
press_button right
