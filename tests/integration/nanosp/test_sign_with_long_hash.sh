...
press_button right
expect_section_content nanosp 'Amount' '0 tz'
press_button right
expect_section_content nanosp 'Destination' 'KT1GW4QHn66m7WWWMWCMNaWmGYpCRbg5ahwU'
press_button right
expect_section_content nanosp 'Entrypoint' 'root'
press_button right
expect_section_content nanosp 'Parameter' '0'
press_button right
