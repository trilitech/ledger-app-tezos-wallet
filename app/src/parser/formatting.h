...
// Returns the human readable name of a Michelson op_code if valid
// (`op_code <= LAST_MICHELSON_OPCODE`), or `NULL`. This function
// needs to be updated when new michelson instructions are added via a
...
// Formats a positive number of arbitrary to decimal. The number is
