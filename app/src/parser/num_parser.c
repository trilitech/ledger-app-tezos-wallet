...
bool
tz_adjust_decimal(const char *in, int in_len, char *out, int out_len,
                  int nb_decimals)
{
    int offset = 0;
...
bool
tz_print_uint64(uint64_t value, char *out, int out_len, int nb_decimals)
{
