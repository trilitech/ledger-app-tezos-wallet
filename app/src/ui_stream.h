...
typedef enum : uint8_t {
    ...
    TZ_UI_LAYOUT_HOME_BNP = (TZ_UI_LAYOUT_HOME_MASK | TZ_UI_LAYOUT_BNP),
    TZ_UI_LAYOUT_HOME_BP  = (TZ_UI_LAYOUT_HOME_MASK | TZ_UI_LAYOUT_BP),
    TZ_UI_LAYOUT_HOME_NP  = (TZ_UI_LAYOUT_HOME_MASK | TZ_UI_LAYOUT_NP)
} tz_ui_layout_type_t;
