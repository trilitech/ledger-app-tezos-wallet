...
tz_err_t read_bip32_path(bip32_path_t *const out, uint8_t const *const in,
                         size_t in_size) {
...
tz_err_t generate_public_key(cx_ecfp_public_key_t *public_key,
...
tz_err_t public_key_hash(uint8_t *hash_out, size_t hash_out_size,
...
tz_err_t sign(derivation_type_t derivation_type,
