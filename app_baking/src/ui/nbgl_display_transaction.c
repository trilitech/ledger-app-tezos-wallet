...
static void
confirm_transaction_rejection(void)
{
...
static void
ask_transaction_rejection_confirmation(void)
{
...
review_continue(void)
{
    ...
    nbgl_useCaseStaticReview(&pairList, &infoLongPress, "Reject transaction",
                             review_choice);
}
