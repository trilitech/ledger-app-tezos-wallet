...
static void
ui_action_validate_pubkey(bool choice)
{
...
static void
ui_action_validate_transaction(bool choice)
{
...
UX_FLOW(ux_display_pubkey_flow, &ux_display_confirm_addr_step,
        &ux_display_address_step, &ux_display_approve_step,
...
UX_FLOW(ux_display_transaction_flow, &ux_display_review_step,
        &ux_display_address_step, &ux_display_amount_step,
...
ui_display_transaction()
{
    ...
    char amount[30] = {0};
    if (!format_fpu64(amount, sizeof(amount),
